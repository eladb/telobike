...
require.define("/phonegap/src/station-app.js",function(require,module,exports,__dirname,__filename,process){var station = require('./station-panel');
...
var toggle_button = app.add(station.button({
  x: 500,
  y: 10,
  text: 'toggle',
}));
...
require.define("/phonegap/src/.tmp.42731.entry.station-app.js",function(require,module,exports,__dirname,__filename,process){window.require = require;

// lazy require so that app code will not execute before onload
Object.defineProperty(window, 'main', {
  get: function() {
    return require('./station-app.js');
  }
});});
require("/phonegap/src/.tmp.42731.entry.station-app.js");
})();
